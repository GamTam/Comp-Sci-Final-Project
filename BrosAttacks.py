...
class SandoonBrosAttack(pg.sprite.Sprite):
    def __init__(self, game, enemy):
        pg.sprite.Sprite.__init__(self)
        self.game = game
        self.hit = False
    ...
    def loadImages(self):
        sheet = spritesheet("sprites/sandoonBrosAttack.png", "sprites/sandoonBrosAttack.xml")
...
class AnubooBrosAttack(pg.sprite.Sprite):
    def __init__(self, game, enemy):
        pg.sprite.Sprite.__init__(self)
        self.game = game
        self.hit = False
    ...
    def loadImages(self):
        ...
        self.standingFrames = [sheet.getImageName("idle.png")]
...
class SpikySnifitBrosAttack(pg.sprite.Sprite):
    def __init__(self, game, enemy):
        pg.sprite.Sprite.__init__(self)
        self.game = game
        self.hit = False
...
class DarkFawfulBrosAttack(pg.sprite.Sprite):
    def __init__(self, game, enemy):
        pg.sprite.Sprite.__init__(self)
        self.game = game
        self.hit = False
