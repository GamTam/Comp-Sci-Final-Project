...
class Game:
    ...
    def newGame(self):
        ...
        appear = LineFlip(self, pg.image.load("sprites/peachincage.png").convert_alpha(), (self.map.width / 2, 900))
        ...
        appear = LineFlip(self, bleckIdle[0], (self.map.width / 2, 900), sound="bleck")
