...
lightningSprites = [pg.image.load("sprites/lightning/1.png").convert_alpha(),
               pg.image.load("sprites/lightning/2.png").convert_alpha(),
               pg.image.load("sprites/lightning/3.png").convert_alpha(),
               pg.image.load("sprites/lightning/4.png").convert_alpha(),
               pg.image.load("sprites/lightning/5.png").convert_alpha(),
               pg.image.load("sprites/lightning/6.png").convert_alpha(),
               pg.image.load("sprites/lightning/7.png").convert_alpha(),
               pg.image.load("sprites/lightning/8.png").convert_alpha(),
               pg.image.load("sprites/lightning/9.png").convert_alpha(),
               pg.image.load("sprites/lightning/10.png").convert_alpha(),
               pg.image.load("sprites/lightning/11.png").convert_alpha(),
               pg.image.load("sprites/lightning/12.png").convert_alpha(),
               pg.image.load("sprites/lightning/13.png").convert_alpha(),
               pg.image.load("sprites/lightning/14.png").convert_alpha(),
               pg.image.load("sprites/lightning/15.png").convert_alpha(),
               pg.image.load("sprites/lightning/16.png").convert_alpha(),
               pg.image.load("sprites/lightning/17.png").convert_alpha(),
               pg.image.load("sprites/lightning/18.png").convert_alpha(),
               pg.image.load("sprites/lightning/19.png").convert_alpha(),
               pg.image.load("sprites/lightning/20.png").convert_alpha(),
               pg.image.load("sprites/lightning/21.png").convert_alpha(),
               pg.image.load("sprites/lightning/22.png").convert_alpha(),
               pg.image.load("sprites/lightning/23.png").convert_alpha(),
               pg.image.load("sprites/lightning/24.png").convert_alpha(),
               pg.image.load("sprites/lightning/25.png").convert_alpha(),
               pg.image.load("sprites/lightning/26.png").convert_alpha(),
               pg.image.load("sprites/lightning/27.png").convert_alpha(),
               pg.image.load("sprites/lightning/28.png").convert_alpha(),
               pg.image.load("sprites/lightning/29.png").convert_alpha(),
               pg.image.load("sprites/lightning/30.png").convert_alpha(),
               pg.image.load("sprites/lightning/31.png").convert_alpha(),
               pg.image.load("sprites/lightning/32.png").convert_alpha(),
               pg.image.load("sprites/lightning/33.png").convert_alpha(),
               pg.image.load("sprites/lightning/34.png").convert_alpha(),
               pg.image.load("sprites/lightning/35.png").convert_alpha(),
               pg.image.load("sprites/lightning/36.png").convert_alpha(),
               pg.image.load("sprites/lightning/37.png").convert_alpha(),
               pg.image.load("sprites/lightning/38.png").convert_alpha(),
               pg.image.load("sprites/lightning/39.png").convert_alpha(),
               pg.image.load("sprites/lightning/40.png").convert_alpha(),
               pg.image.load("sprites/lightning/41.png").convert_alpha(),
               pg.image.load("sprites/lightning/42.png").convert_alpha(),
               pg.image.load("sprites/lightning/43.png").convert_alpha(),
               pg.image.load("sprites/lightning/44.png").convert_alpha(),
               pg.image.load("sprites/lightning/45.png").convert_alpha(),
               pg.image.load("sprites/lightning/46.png").convert_alpha(),
               pg.image.load("sprites/lightning/47.png").convert_alpha(),
               pg.image.load("sprites/lightning/48.png").convert_alpha(),
               pg.image.load("sprites/lightning/49.png").convert_alpha(),
               pg.image.load("sprites/lightning/50.png").convert_alpha(),
               pg.image.load("sprites/lightning/51.png").convert_alpha(),
               pg.image.load("sprites/lightning/52.png").convert_alpha(),
               pg.image.load("sprites/lightning/53.png").convert_alpha(),
               pg.image.load("sprites/lightning/54.png").convert_alpha(),
               pg.image.load("sprites/lightning/55.png").convert_alpha(),
               pg.image.load("sprites/lightning/56.png").convert_alpha(),
               pg.image.load("sprites/lightning/57.png").convert_alpha(),
               pg.image.load("sprites/lightning/58.png").convert_alpha(),
               pg.image.load("sprites/lightning/59.png").convert_alpha(),
               pg.image.load("sprites/lightning/60.png").convert_alpha(),
               pg.image.load("sprites/lightning/61.png").convert_alpha(),
               pg.image.load("sprites/lightning/62.png").convert_alpha(),
               pg.image.load("sprites/lightning/63.png").convert_alpha(),
               pg.image.load("sprites/lightning/64.png").convert_alpha(),
               pg.image.load("sprites/lightning/65.png").convert_alpha(),
               pg.image.load("sprites/lightning/66.png").convert_alpha(),
               pg.image.load("sprites/lightning/67.png").convert_alpha(),
               pg.image.load("sprites/lightning/68.png").convert_alpha(),
               pg.image.load("sprites/lightning/69.png").convert_alpha(),
               pg.image.load("sprites/lightning/70.png").convert_alpha(),
               pg.image.load("sprites/lightning/71.png").convert_alpha(),
               pg.image.load("sprites/lightning/72.png").convert_alpha(),
               pg.image.load("sprites/lightning/73.png").convert_alpha(),
               pg.image.load("sprites/lightning/74.png").convert_alpha(),
               pg.image.load("sprites/lightning/75.png").convert_alpha(),
               pg.image.load("sprites/lightning/76.png").convert_alpha(),
               pg.image.load("sprites/lightning/77.png").convert_alpha(),
               pg.image.load("sprites/lightning/78.png").convert_alpha(),
               pg.image.load("sprites/lightning/79.png").convert_alpha(),
               pg.image.load("sprites/lightning/80.png").convert_alpha(),
               pg.image.load("sprites/lightning/81.png").convert_alpha(),
               pg.image.load("sprites/lightning/82.png").convert_alpha(),
               pg.image.load("sprites/lightning/83.png").convert_alpha(),
               pg.image.load("sprites/lightning/84.png").convert_alpha(),
               pg.image.load("sprites/lightning/85.png").convert_alpha(),
               pg.image.load("sprites/lightning/86.png").convert_alpha(),
               pg.image.load("sprites/lightning/87.png").convert_alpha(),
               pg.image.load("sprites/lightning/88.png").convert_alpha(),
               pg.image.load("sprites/lightning/89.png").convert_alpha(),
               pg.image.load("sprites/lightning/90.png").convert_alpha(),
               pg.image.load("sprites/lightning/91.png").convert_alpha(),
               pg.image.load("sprites/lightning/92.png").convert_alpha(),
               pg.image.load("sprites/lightning/93.png").convert_alpha(),
               pg.image.load("sprites/lightning/94.png").convert_alpha(),
               pg.image.load("sprites/lightning/95.png").convert_alpha(),
               pg.image.load("sprites/lightning/96.png").convert_alpha(),
               pg.image.load("sprites/lightning/97.png").convert_alpha(),
               pg.image.load("sprites/lightning/98.png").convert_alpha(),
               pg.image.load("sprites/lightning/99.png").convert_alpha(),
               pg.image.load("sprites/lightning/100.png").convert_alpha(),
               pg.image.load("sprites/lightning/101.png").convert_alpha(),
               pg.image.load("sprites/lightning/102.png").convert_alpha(),
               pg.image.load("sprites/lightning/103.png").convert_alpha(),
               pg.image.load("sprites/lightning/104.png").convert_alpha(),
               pg.image.load("sprites/lightning/105.png").convert_alpha(),
               pg.image.load("sprites/lightning/106.png").convert_alpha(),
               pg.image.load("sprites/lightning/107.png").convert_alpha(),
               pg.image.load("sprites/lightning/108.png").convert_alpha(),
               pg.image.load("sprites/lightning/109.png").convert_alpha(),
               pg.image.load("sprites/lightning/110.png").convert_alpha(),
               pg.image.load("sprites/lightning/111.png").convert_alpha(),
               pg.image.load("sprites/lightning/112.png").convert_alpha(),
               pg.image.load("sprites/lightning/113.png").convert_alpha(),
               pg.image.load("sprites/lightning/114.png").convert_alpha(),
               pg.image.load("sprites/lightning/115.png").convert_alpha(),
               pg.image.load("sprites/lightning/116.png").convert_alpha(),
               pg.image.load("sprites/lightning/117.png").convert_alpha(),
               pg.image.load("sprites/lightning/118.png").convert_alpha(),
               pg.image.load("sprites/lightning/119.png").convert_alpha(),
               pg.image.load("sprites/lightning/120.png").convert_alpha(),
               pg.image.load("sprites/lightning/121.png").convert_alpha(),
               pg.image.load("sprites/lightning/122.png").convert_alpha(),
               pg.image.load("sprites/lightning/123.png").convert_alpha(),
               pg.image.load("sprites/lightning/124.png").convert_alpha(),
               pg.image.load("sprites/lightning/125.png").convert_alpha(),
               pg.image.load("sprites/lightning/126.png").convert_alpha(),
               pg.image.load("sprites/lightning/127.png").convert_alpha(),
               pg.image.load("sprites/lightning/128.png").convert_alpha(),
               pg.image.load("sprites/lightning/129.png").convert_alpha(),
               pg.image.load("sprites/lightning/130.png").convert_alpha(),
               pg.image.load("sprites/lightning/131.png").convert_alpha(),
               pg.image.load("sprites/lightning/132.png").convert_alpha(),
               pg.image.load("sprites/lightning/133.png").convert_alpha(),
               pg.image.load("sprites/lightning/134.png").convert_alpha(),
               pg.image.load("sprites/lightning/135.png").convert_alpha(),
               pg.image.load("sprites/lightning/136.png").convert_alpha(),
               pg.image.load("sprites/lightning/137.png").convert_alpha(),
               pg.image.load("sprites/lightning/138.png").convert_alpha(),
               pg.image.load("sprites/lightning/139.png").convert_alpha(),
               pg.image.load("sprites/lightning/140.png").convert_alpha(),
               pg.image.load("sprites/lightning/141.png").convert_alpha(),
               pg.image.load("sprites/lightning/142.png").convert_alpha(),
               pg.image.load("sprites/lightning/143.png").convert_alpha(),
               pg.image.load("sprites/lightning/144.png").convert_alpha(),
               pg.image.load("sprites/lightning/145.png").convert_alpha(),
               pg.image.load("sprites/lightning/146.png").convert_alpha(),
               pg.image.load("sprites/lightning/147.png").convert_alpha(),
               pg.image.load("sprites/lightning/148.png").convert_alpha(),
               pg.image.load("sprites/lightning/149.png").convert_alpha(),
               pg.image.load("sprites/lightning/150.png").convert_alpha(),
               pg.image.load("sprites/lightning/151.png").convert_alpha(),
               pg.image.load("sprites/lightning/152.png").convert_alpha(),
               pg.image.load("sprites/lightning/153.png").convert_alpha(),
               pg.image.load("sprites/lightning/154.png").convert_alpha(),
               pg.image.load("sprites/lightning/155.png").convert_alpha(),
               pg.image.load("sprites/lightning/156.png").convert_alpha(),
               pg.image.load("sprites/lightning/157.png").convert_alpha(),
               pg.image.load("sprites/lightning/158.png").convert_alpha(),
               pg.image.load("sprites/lightning/159.png").convert_alpha(),
               pg.image.load("sprites/lightning/160.png").convert_alpha(),
               pg.image.load("sprites/lightning/161.png").convert_alpha(),
               pg.image.load("sprites/lightning/162.png").convert_alpha(),
               pg.image.load("sprites/lightning/163.png").convert_alpha(),
               pg.image.load("sprites/lightning/164.png").convert_alpha(),
               pg.image.load("sprites/lightning/165.png").convert_alpha(),
               pg.image.load("sprites/lightning/166.png").convert_alpha(),
               pg.image.load("sprites/lightning/167.png").convert_alpha(),
               pg.image.load("sprites/lightning/168.png").convert_alpha(),
               pg.image.load("sprites/lightning/169.png").convert_alpha(),
               pg.image.load("sprites/lightning/170.png").convert_alpha(),
               pg.image.load("sprites/lightning/171.png").convert_alpha(),
               pg.image.load("sprites/lightning/172.png").convert_alpha(),
               pg.image.load("sprites/lightning/173.png").convert_alpha(),
               pg.image.load("sprites/lightning/174.png").convert_alpha(),
               pg.image.load("sprites/lightning/175.png").convert_alpha(),
               pg.image.load("sprites/lightning/176.png").convert_alpha(),
               pg.image.load("sprites/lightning/177.png").convert_alpha(),
               pg.image.load("sprites/lightning/178.png").convert_alpha(),
               pg.image.load("sprites/lightning/179.png").convert_alpha(),
               pg.image.load("sprites/lightning/180.png").convert_alpha()]
